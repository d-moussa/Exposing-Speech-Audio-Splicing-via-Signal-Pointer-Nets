random_seed = 42
config_name = "ACE all 0-1 Data Config"
set_name = "ace"
experiment_name = "all"

data_path = "data/prepared/"  # Path to processed speech audio

min_split_points = 0  # Minimum number of splices per sample
max_split_points = 1  # Maximum number of splices per sample
dataset_size_train = 500000  # Number of samples in train set
dataset_size_val = 30000  # Number of samples in validation set
dataset_size_test = 30000  # Number of samples in test set
package_size = 50000  # Splits the datasets in smaller packages of this size
...
dataset_root_path = "datasets/ace/all/"  # Path to the actual datasets and to the dataset dictionaries
dataset_pickle_name_train = "train_all_single"  # Filenames
dataset_pickle_name_val = "val_all_single"
dataset_pickle_name_test = "test_all_single"
dataset_path_train = "datasets/ace/all/dataset_train_ace_01.json"
dataset_path_val = "datasets/ace/all/dataset_val_ace_01.json"
dataset_path_test = "datasets/ace/all/dataset_test_ace_01.json"

silence_path_train = "datasets/ace/all/silence_train_ace_01.json"
silence_path_val = "datasets/ace/all/silence_val_ace_01.json"
silence_path_test = "datasets/ace/all/silence_test_ace_01.json"
