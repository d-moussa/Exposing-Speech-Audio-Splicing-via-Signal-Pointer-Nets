random_seed = 42
config_name = "TTS realnoise train 0-5 Data Config"
set_name = "tts"
experiment_name = "realnoiseTrain"
...
dataset_pickle_name_test = "test_realnoise_train_m"
dataset_path_train = ""
dataset_path_val = ""
...
noise_file = "data/custom_noise/train.wav"
snr_db_train = [None]
snr_db_val = [None]
