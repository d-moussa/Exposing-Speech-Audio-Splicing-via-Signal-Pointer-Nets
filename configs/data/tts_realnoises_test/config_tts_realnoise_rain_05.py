random_seed = 42
config_name = "TTS realnoise rain 0-5 Data Config"
set_name = "tts"
experiment_name = "realnoiseRain"
...
dataset_pickle_name_test = "test_realnoise_rain_m"
dataset_path_train = ""
dataset_path_val = ""
...
noise_file = "data/custom_noise/rain.wav"
snr_db_train = [None]
snr_db_val = [None]
