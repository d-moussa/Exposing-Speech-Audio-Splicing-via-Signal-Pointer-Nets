...
save_model_dir = "models/sig_pointer/"  # Output dir of model
early_stopping_wait = 20  # Wait for N epochs for improvement
early_stopping_delta = 0.  # Minimal accepted improvement

load_checkpoint_path = "models/sig_pointer/sig_pointer_3.pth"  # Path to pretrained weights or None

model_name = "sig_pointer_3"  # Name of model (train: write to, predict: load from)
