...
load_checkpoint_path = "models/sig_pointer/sig_pointer_5.pth"  # Path to pretrained weights or None

model_name = "sig_pointer_5"  # Name of model (train: write to, predict: load from)
