...
load_checkpoint_path = "models/transformer_encoder/transformer_encoder_4.pth"  # Path to pretrained weights or None

model_name = "transformer_encoder_4"  # Name of model (train: write to, predict: load from)
