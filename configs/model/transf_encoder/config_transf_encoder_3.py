...
load_checkpoint_path = "models/transformer_encoder/transformer_encoder_3.pth"  # Path to pretrained weights or None

model_name = "transformer_encoder_3"  # Name of model (train: write to, predict: load from)
