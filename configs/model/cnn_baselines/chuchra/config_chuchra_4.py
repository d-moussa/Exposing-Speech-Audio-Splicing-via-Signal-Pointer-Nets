...
load_checkpoint_path = "models/chuchra/chuchra_4.pth"  # Path to pretrained weights or None

model_name = "chuchra_4"  # Name of model (train: write to, predict: load from)
