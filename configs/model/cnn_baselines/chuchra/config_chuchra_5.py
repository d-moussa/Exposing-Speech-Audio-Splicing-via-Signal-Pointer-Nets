...
load_checkpoint_path = "models/chuchra/chuchra_5.pth"  # Path to pretrained weights or None

model_name = "chuchra_5"  # Name of model (train: write to, predict: load from)
