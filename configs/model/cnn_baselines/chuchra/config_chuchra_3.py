...
load_checkpoint_path = "models/chuchra/chuchra_3.pth"  # Path to pretrained weights or None

model_name = "chuchra_3"  # Name of model (train: write to, predict: load from)
