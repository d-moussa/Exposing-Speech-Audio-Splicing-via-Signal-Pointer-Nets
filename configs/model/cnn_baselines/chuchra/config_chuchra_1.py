...
load_checkpoint_path = "models/chuchra/chuchra_1.pth"  # Path to pretrained weights or None

model_name = "chuchra_1"  # Name of model (train: write to, predict: load from)
